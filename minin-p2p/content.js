...
async function handleFormSubmission() {
    ...
    if (!formData.createdAt) {
        ...
        // ордера из API биржи при верификации — просто не шлём createdAt.
        console.warn('P2P Analytics: Не удалось определить дату создания заказа со страницы, дата будет взята из API биржи на сервере.');
    }
