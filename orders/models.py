...
# Пресеты для поля "Банк" в реквизитах расчётного счёта (settings.html) —
# готовый выбор в <select>, плюс пункт "Ввести вручную" для остальных банков.
# Значения должны совпадать с value= у <option> в settings.html.
PRESET_BANK_NAMES = [
    "ПАО Сбербанк",
    "АО Альфа-Банк",
    "АО Т-Банк",
