...
# Прогрессивная шкала НДФЛ (с 2025): (порог нарастающим итогом, ставка, КБК)
NDFL_BRACKETS = [
    (Decimal("2400000"),   Decimal("0.13"), "18210102010011000110"),
    (Decimal("5000000"),   Decimal("0.15"), "18210102020011000110"),
    (Decimal("20000000"),  Decimal("0.18"), "18210102150011000110"),
    (Decimal("50000000"),  Decimal("0.20"), "18210102160011000110"),
    (None,                 Decimal("0.22"), "18210102170011000110"),
]
